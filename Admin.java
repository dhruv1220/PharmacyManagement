...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Password alotted");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String name,age,address,password,id;
        try{
            ...
            if(conn1.isValid(1)){
                ...
                p1=conn1.prepareStatement("insert into EMPLOYEE(name,age,address,password,id) values(?,?,?,?,?)");
                p1.setString(1, name);
                p1.setString(2, age);
